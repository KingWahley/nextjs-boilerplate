...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="relative hidden lg:flex flex-col justify-between bg-slate-900 text p-12 text-white">
      ...
      <div className="flex items-center justify-center p-8 bg-slate-50">
        <div className="w-full max-w-[420px]">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-white border-slate-300"
                />
                <button
                  type="button"
          ...
          <div className="mt-6">
            <Button
              variant="outline"
              className="w-full h-12 bg-white border-slate-300 hover:bg-slate-100"
              type="button"
            >
